 ...
 * @author Peter Abeles
 */
    public class FMatrixSparseCSC : FMatrixSparse
    {
        /**
        ...
        public FMatrixSparseCSC(int numRows, int numCols, int arrayLength)
        {
            ...
            nz_values = new float[arrayLength];
        ...
        public virtual void reshape(int nRows, int nCols, int arrayLength)
        {
            ...
            if (nCols + 1 > col_idx.Length)
            {
                col_idx = new int[nCols + 1];
            }
            else
            {
                Array.Clear(col_idx, 0, nCols + 1);
            }
        }
