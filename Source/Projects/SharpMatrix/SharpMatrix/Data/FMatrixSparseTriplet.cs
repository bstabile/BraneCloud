 ...
 * @author Peter Abeles
 */
    public class FMatrixSparseTriplet : FMatrixSparse
    {
        ...
        public virtual void set(int row, int col, float value)
        {
        ...
        public virtual void unsafe_set(int row, int col, float value)
        {
        ...
        {
            return new FMatrixSparseTriplet(numRows, numCols, nz_length);
        }
