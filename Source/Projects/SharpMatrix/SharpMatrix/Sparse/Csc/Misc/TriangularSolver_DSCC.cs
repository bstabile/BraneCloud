 ...
 */
    public class TriangularSolver_DSCC
    {
         ...
         */
        public static int solve(DMatrixSparseCSC G, bool lower,
         ...
         */
        public static void eliminationTree(DMatrixSparseCSC A, bool ata, int[] parent, IGrowArray gwork)
        {
            int m = A.numRows;
            int n = A.numCols;

            if (parent.Length < n)
                throw new ArgumentException("parent must be of length N");
