...
//@SuppressWarnings("Duplicates")
    public class MatrixMatrixMult_CDRM
    {
        ...
        public static void multTransA_reorder(float realAlpha, float imagAlpha, CMatrixRMaj a, CMatrixRMaj b,
            CMatrixRMaj c)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
        ...
        public static void multTransA_small(float realAlpha, float imagAlpha, CMatrixRMaj a, CMatrixRMaj b,
            CMatrixRMaj c)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
        ...
        public static void multTransAB_aux(float realAlpha, float imagAlpha, CMatrixRMaj a, CMatrixRMaj b,
            CMatrixRMaj c, float[]aux)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
            else if (a.numRows != b.numCols)
        ...
        public static void multAdd_reorder(float realAlpha, float imagAlpha, CMatrixRMaj a, CMatrixRMaj b,
            CMatrixRMaj c)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
        ...
        public static void multAddTransA_reorder(float realAlpha, float imagAlpha, CMatrixRMaj a, CMatrixRMaj b,
            CMatrixRMaj c)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
        ...
        public static void multAddTransA_small(float realAlpha, float imagAlpha, CMatrixRMaj a, CMatrixRMaj b,
            CMatrixRMaj c)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
        ...
        public static void multAddTransAB_aux(float realAlpha, float imagAlpha, CMatrixRMaj a, CMatrixRMaj b,
            CMatrixRMaj c, float[]aux)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
