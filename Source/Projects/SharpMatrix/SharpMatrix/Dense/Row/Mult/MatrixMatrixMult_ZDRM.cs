...
//@SuppressWarnings("Duplicates")
    public class MatrixMatrixMult_ZDRM
    {
        ...
        public static void multTransA_reorder(double realAlpha, double imagAlpha, ZMatrixRMaj a, ZMatrixRMaj b,
            ZMatrixRMaj c)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
        ...
        public static void multTransA_small(double realAlpha, double imagAlpha, ZMatrixRMaj a, ZMatrixRMaj b,
            ZMatrixRMaj c)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
        ...
        public static void multTransAB_aux(double realAlpha, double imagAlpha, ZMatrixRMaj a, ZMatrixRMaj b,
            ZMatrixRMaj c, double[]aux)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
            else if (a.numRows != b.numCols)
        ...
        public static void multAdd_reorder(double realAlpha, double imagAlpha, ZMatrixRMaj a, ZMatrixRMaj b,
            ZMatrixRMaj c)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
        ...
        public static void multAdd_small(double realAlpha, double imagAlpha, ZMatrixRMaj a, ZMatrixRMaj b,
            ZMatrixRMaj c)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
        ...
        public static void multAddTransA_reorder(double realAlpha, double imagAlpha, ZMatrixRMaj a, ZMatrixRMaj b,
            ZMatrixRMaj c)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
        ...
        public static void multAddTransA_small(double realAlpha, double imagAlpha, ZMatrixRMaj a, ZMatrixRMaj b,
            ZMatrixRMaj c)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
        ...
        public static void multAddTransAB_aux(double realAlpha, double imagAlpha, ZMatrixRMaj a, ZMatrixRMaj b,
            ZMatrixRMaj c, double[]aux)
        {
            if (a == c || b == c)
                throw new ArgumentException("Neither 'a' or 'b' can be the same matrix as 'c'");
