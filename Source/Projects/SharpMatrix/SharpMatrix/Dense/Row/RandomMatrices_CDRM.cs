 ...
 */
    public class RandomMatrices_CDRM
    {
         ...
         */
        public static CMatrixRMaj rectangle(int numRow, int numCol, IMersenneTwister rand)
        {
         ...
         * @param rand Random number generator used to fill the matrix.
         */
        public static void fillUniform(CMatrixRMaj mat, IMersenneTwister rand)
        {
...
//     * @return The randomly generated matrix.
//     */
//    public static CMatrixRMaj createUpperTriangle( int dimen , int hessenberg , float min , float max , IMersenneTwister rand )
//    {
//        if( hessenberg < 0 )
