...
//@SuppressWarnings({"ForLoopReplaceableByForEach"})
    public class CommonOps_DDRM
    {
         ...
         */
        public static DMatrixRMaj extractRow(DMatrixRMaj a, int row, DMatrixRMaj output)
        {
            if (output == null)
                output = new DMatrixRMaj(1, a.numCols);
            else if (!MatrixFeatures_DDRM.isVector(output) || output.getNumElements() != a.numCols)
         ...
         */
        public static DMatrixRMaj extractColumn(DMatrixRMaj a, int column, DMatrixRMaj output)
        {
            if (output == null)
                output = new DMatrixRMaj(a.numRows, 1);
            else if (!MatrixFeatures_DDRM.isVector(output) || output.getNumElements() != a.numRows)
         ...
         */
        public static DMatrixRMaj concatColumns(params DMatrixRMaj[] m)
        {
            int rows = 0;
            int cols = 0;
         ...
         * @return Resulting matrix
         */
        public static DMatrixRMaj concatRows(params DMatrixRMaj[] m)
        {
            int rows = 0;
            int cols = 0;
