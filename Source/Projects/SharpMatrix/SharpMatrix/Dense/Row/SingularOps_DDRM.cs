...
//        checkSvdMatrixSize(U, tranU, W, V, tranV);
         ...
         */
        public static void checkSvdMatrixSize(DMatrixRMaj U, bool tranU, DMatrixRMaj W, DMatrixRMaj V, bool tranV)
        {
            int numSingular = Math.Min(W.numRows, W.numCols);
         ...
         */
        public static double singularThreshold(SingularValueDecomposition_F64<DMatrixRMaj> svd)
        {
            double largest = 0;
         ...
         */
        public static int rank(SingularValueDecomposition_F64<DMatrixRMaj> svd)
        {
         ...
         * @return The rank of the decomposed matrix.
         */
        public static int rank(SingularValueDecomposition_F64<DMatrixRMaj> svd, double threshold)
        {
            int numRank = 0;
         ...
         */
        public static int nullity(SingularValueDecomposition_F64<DMatrixRMaj> svd)
        {
            double threshold = singularThreshold(svd);
         ...
         * @return The nullity of the decomposed matrix.
         */
        public static int nullity(SingularValueDecomposition_F64<DMatrixRMaj> svd, double threshold)
        {
            int ret = 0;
