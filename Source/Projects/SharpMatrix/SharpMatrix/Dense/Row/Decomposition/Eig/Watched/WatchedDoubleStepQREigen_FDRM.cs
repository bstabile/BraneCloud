...
namespace BraneCloud.Evolution.EC.MatrixLib.Dense.Row.Decomposition.Eig.Watched
{
...
// TODO option of modifying original matrix
    public class WatchedDoubleStepQREigen_FDRM
    {
        ...
        internal int steps;
        internal Complex_F32[] eigenvalues;
        ...
        {
            if (printHumps)
                Console.WriteLine("Performing exceptional implicit float step");
        ...
        {
            if (printHumps)
                Console.WriteLine("Performing implicit float step");
...
//        A.print("%12.3fe");
        ...
        public bool createBulgeSingleStep(int x1, float eigenvalue)
        {
