 ...
 * @author Peter Abeles
 */
    public class CholeskyDecompositionLDL_FDRM : CholeskyLDLDecomposition_F32<FMatrixRMaj>
    {
         ...
         */
        public bool decompose(FMatrixRMaj mat)
        {
        ...
        public virtual FMatrixRMaj getL(FMatrixRMaj L)
        {
            if (L == null)
            {
                L = (FMatrixRMaj) this.L.copy();
            }
            else
            {
                L.set(this.L);
        ...
        public virtual FMatrixRMaj getD(FMatrixRMaj D)
        {
