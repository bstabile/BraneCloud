 ...
 * @author Peter Abeles
 */
    public class BidiagonalDecompositionRow_DDRM : BidiagonalDecomposition_F64<DMatrixRMaj>
    {
        ...
        public virtual DMatrixRMaj getB(DMatrixRMaj B, bool compact)
        {
            ...
            //Array.Copy(UBV.data, 0, B.data, 0, UBV.getNumElements());
        ...
        public static DMatrixRMaj handleB(DMatrixRMaj B, bool compact,
            int m, int n, int min)
        {
            int w = n > m ? min + 1 : min;
...
//        UBV.print();
        ...
        public static DMatrixRMaj handleV(DMatrixRMaj V, bool transpose, bool compact,
            int m, int n, int min)
        {
            int w = n > m ? min + 1 : min;
