 ...
 * @author Peter Abeles
 */
    public class BidiagonalDecompositionRow_FDRM : BidiagonalDecomposition_F32<FMatrixRMaj>
    {
        ...
        public static FMatrixRMaj handleB(FMatrixRMaj B, bool compact,
            int m, int n, int min)
        {
            int w = n > m ? min + 1 : min;
...
//        UBV.print();
        ...
        public static FMatrixRMaj handleV(FMatrixRMaj V, bool transpose, bool compact,
            int m, int n, int min)
        {
            int w = n > m ? min + 1 : min;
