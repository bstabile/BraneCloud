 ...
 * @author Peter Abeles
 */
    public class QRColPivDecompositionHouseholderColumn_DDRM : QRDecompositionHouseholderColumn_DDRM,
        QRPDecomposition_F64<DMatrixRMaj>
    {
        ...
        public virtual void setSingularThreshold(double threshold)
        {
        ...
        public virtual DMatrixRMaj getColPivotMatrix(DMatrixRMaj P)
        {
            if (P == null)
