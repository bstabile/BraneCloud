 ...
 */
    public class QrUpdate_FDRM
    {
         ...
         * @param autoGrow
         */
        public QrUpdate_FDRM(int maxRows, int maxCols, bool autoGrow)
        {
        ...
        private void setQR(FMatrixRMaj Q, FMatrixRMaj R, int growRows)
        {
            ...
            {
                throw new ArgumentException("Q should be square.");
            }
            ...
            if (m + growRows > maxRows || n > maxCols)
            {
                ...
                {
                    throw new ArgumentException("Autogrow has been set to false and the maximum number of rows" +
