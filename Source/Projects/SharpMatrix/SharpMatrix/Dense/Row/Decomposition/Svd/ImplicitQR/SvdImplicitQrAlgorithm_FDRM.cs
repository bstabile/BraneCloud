 ...
 */
    public class SvdImplicitQrAlgorithm_FDRM
    {
        ...
        private readonly int maxIterations = 15 * 100;
...
//    SimpleMatrix B;
        ...
        public SvdImplicitQrAlgorithm_FDRM(bool fastValues)
        {
...
//        return Math.Abs(diag[i]) <= maxValue* UtilEjml.F_EPS;
         ...
         */
        public void performImplicitSingleStep(float scale, float lambda, bool byAngle)
        {
...
//        return Math.Max(scale,Math.Abs(b22));
         ...
         */
        protected void createBulge(int x1, float p, float scale, bool byAngle)
        {
            float b11 = diag[x1];
            float b12 = off[x1];
            float b22 = diag[x1 + 1];
...
//            Console.WriteLine();
        ...
        protected void eigenBB_2x2(int x1)
        {
            ...
            float sgn = Signum(eigenSmall.value1.real);
