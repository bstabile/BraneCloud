 ...
 */
    public class RandomMatrices_ZDRM
    {
         ...
         */
        public static ZMatrixRMaj rectangle(int numRow, int numCol, IMersenneTwister rand)
        {
         ...
         * @return The randomly generated matrix.
         */
        public static ZMatrixRMaj rectangle(int numRow, int numCol, double min, double max, IMersenneTwister rand)
        {
         ...
         * @param rand Random number generator.
         */
        public static void fillHermitian(ZMatrixRMaj A, double min, double max, IMersenneTwister rand)
        {
...
//     * @return The randomly generated matrix.
//     */
//    public static ZMatrixRMaj createUpperTriangle( int dimen , int hessenberg , double min , double max , IMersenneTwister rand )
//    {
//        if( hessenberg < 0 )
