 ...
 */
    public class BlockHouseHolder_FDRB
    {
        ...
        public static void rank1UpdateMultR_Col(int blockLength,
            FSubmatrixD1 A, int col, float gamma)
        {
        ...
        public static void rank1UpdateMultL_Row(int blockLength,
            FSubmatrixD1 A,
            int row, int colStart, float gamma)
        {
        ...
        public static void rank1UpdateMultL_LeftCol(int blockLength,
            FSubmatrixD1 A,
            int row, float gamma, int zeroOffset)
        {
...
//                    for( int k = 0; k < height; k++ ) {
        ...
        public static void computeW_Column(int blockLength,
            ...
            float[] temp, float[] beta, int betaIndex)
        {
         ...
         * column 'col'.
         */
        public static void computeZ(int blockLength, FSubmatrixD1 Y, FSubmatrixD1 W,
            int col, float[]temp, float beta)
        {
            int width = Y.col1 - Y.col0;
