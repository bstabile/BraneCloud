 ...
 * @author Peter Abeles
 */
    public class QRDecompositionHouseholder_FDRB : QRDecomposition<FMatrixRBlock>
    {
        ...
        private FSubmatrixD1 W; //ctor => new FSubmatrixD1(dataW);
        private FSubmatrixD1 WTA; // ctor => new FSubmatrixD1(dataWTA);

        public QRDecompositionHouseholder_FDRB()
        {
            W = new FSubmatrixD1(dataW);
            WTA = new FSubmatrixD1(dataWTA);
        }
    ...
    private float[] temp = new float[1];
        ...
        public virtual FMatrixRBlock getQ(FMatrixRBlock Q, bool compact)
        {
...
//            W.original.reshape(W.row1,W.col1,false);
        ...
        public virtual FMatrixRBlock getR(FMatrixRBlock R, bool compact)
        {
