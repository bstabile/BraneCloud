 ...
 */
    public class QRDecompositionHouseholder_DDRB : QRDecomposition<DMatrixRBlock>
    {
        ...
        private DSubmatrixD1 W; // ctor => new DSubmatrixD1(dataW);
        private DSubmatrixD1 WTA; // ctor => WTA = new DSubmatrixD1(dataWTA);
    ...
    public DMatrixRBlock getQR()
        ...
        public virtual DMatrixRBlock getQ(DMatrixRBlock Q, bool compact)
        {
