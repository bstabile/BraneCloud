...
namespace BraneCloud.Evolution.EC.MatrixLib.Dense.Block.Decomposition.Chol
{
...
// TODO merge with CholeskyBlockHelper
    public class InnerCholesky_FDRB
    {
        ...
        public static bool upper(FSubmatrixD1 T)
        {
            int n = T.row1 - T.row0;
         ...
         */
        public static bool upper(float[]T, int indexT, int n)
        {
            float el_ii;
            float div_el_ii = 0;
         ...
         * @return If the decomposition succeeded.
         */
        public static bool lower(float[]T, int indexT, int n)
        {
            float el_ii;
            float div_el_ii = 0;
