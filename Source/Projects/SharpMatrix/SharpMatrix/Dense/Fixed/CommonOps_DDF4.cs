 ...
 */
    public class CommonOps_DDF4
    {
         ...
         */
        public static bool invert(DMatrix4x4 a, DMatrix4x4 inv)
        {
            ...
            double m12 = -(+a21 * (a33 * a44 - a34 * a43) - a23 * (a31 * a44 - a34 * a41) +
                           a24 * (a31 * a43 - a33 * a41));
            double m13 = +a21 * (a32 * a44 - a34 * a42) - a22 * (a31 * a44 - a34 * a41) + a24 * (a31 * a42 - a32 * a41);
            double m14 = -(+a21 * (a32 * a43 - a33 * a42) - a22 * (a31 * a43 - a33 * a41) +
                           a23 * (a31 * a42 - a32 * a41));
            double m21 = -(+a12 * (a33 * a44 - a34 * a43) - a13 * (a32 * a44 - a34 * a42) +
                           a14 * (a32 * a43 - a33 * a42));
            double m22 = +a11 * (a33 * a44 - a34 * a43) - a13 * (a31 * a44 - a34 * a41) + a14 * (a31 * a43 - a33 * a41);
            double m23 = -(+a11 * (a32 * a44 - a34 * a42) - a12 * (a31 * a44 - a34 * a41) +
                           a14 * (a31 * a42 - a32 * a41));
            ...
            double m32 = -(+a11 * (a23 * a44 - a24 * a43) - a13 * (a21 * a44 - a24 * a41) +
                           a14 * (a21 * a43 - a23 * a41));
            double m33 = +a11 * (a22 * a44 - a24 * a42) - a12 * (a21 * a44 - a24 * a41) + a14 * (a21 * a42 - a22 * a41);
            double m34 = -(+a11 * (a22 * a43 - a23 * a42) - a12 * (a21 * a43 - a23 * a41) +
                           a13 * (a21 * a42 - a22 * a41));
            double m41 = -(+a12 * (a23 * a34 - a24 * a33) - a13 * (a22 * a34 - a24 * a32) +
                           a14 * (a22 * a33 - a23 * a32));
            double m42 = +a11 * (a23 * a34 - a24 * a33) - a13 * (a21 * a34 - a24 * a31) + a14 * (a21 * a33 - a23 * a31);
            double m43 = -(+a11 * (a22 * a34 - a24 * a32) - a12 * (a21 * a34 - a24 * a31) +
                           a14 * (a21 * a32 - a22 * a31));
        ...
        public static double det(DMatrix4x4 mat)
        {
            ...
            double ret = 0;
            ret += mat.a11 * (+a11 * (a22 * a33 - a23 * a32) - a12 * (a21 * a33 - a23 * a31) +
                              a13 * (a21 * a32 - a22 * a31));
            a11 = mat.a21;
            a21 = mat.a31;
            a31 = mat.a41;
            ret -= mat.a12 * (+a11 * (a22 * a33 - a23 * a32) - a12 * (a21 * a33 - a23 * a31) +
                              a13 * (a21 * a32 - a22 * a31));
            a12 = mat.a22;
            a22 = mat.a32;
            a32 = mat.a42;
            ret += mat.a13 * (+a11 * (a22 * a33 - a23 * a32) - a12 * (a21 * a33 - a23 * a31) +
                              a13 * (a21 * a32 - a22 * a31));
            a13 = mat.a23;
            a23 = mat.a33;
            a33 = mat.a43;
            ret -= mat.a14 * (+a11 * (a22 * a33 - a23 * a32) - a12 * (a21 * a33 - a23 * a31) +
                              a13 * (a21 * a32 - a22 * a31));
         ...
         */
        public static void diag(DMatrix4x4 input, DMatrix4 output)
        {
            output.a1 = input.a11;
            output.a2 = input.a22;
            output.a3 = input.a33;
         ...
         */
        public static DMatrix4 extractRow(DMatrix4x4 a, int row, DMatrix4 output)
        {
            if (output == null) output = new DMatrix4();
            switch (row)
            {
                case 0:
                    output.a1 = a.a11;
         ...
         */
        public static DMatrix4 extractColumn(DMatrix4x4 a, int column, DMatrix4 output)
        {
            if (output == null) output = new DMatrix4();
            switch (column)
            {
