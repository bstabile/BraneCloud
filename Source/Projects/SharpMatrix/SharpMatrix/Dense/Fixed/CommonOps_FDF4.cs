 ...
 */
    public class CommonOps_FDF4
    {
         ...
         */
        public static bool invert(FMatrix4x4 a, FMatrix4x4 inv)
        {
            ...
            float m21 =
                -(+a12 * (a33 * a44 - a34 * a43) - a13 * (a32 * a44 - a34 * a42) + a14 * (a32 * a43 - a33 * a42));
            float m22 = +a11 * (a33 * a44 - a34 * a43) - a13 * (a31 * a44 - a34 * a41) + a14 * (a31 * a43 - a33 * a41);
            float m23 =
                -(+a11 * (a32 * a44 - a34 * a42) - a12 * (a31 * a44 - a34 * a41) + a14 * (a31 * a42 - a32 * a41));
            ...
            float m32 =
                -(+a11 * (a23 * a44 - a24 * a43) - a13 * (a21 * a44 - a24 * a41) + a14 * (a21 * a43 - a23 * a41));
            float m33 = +a11 * (a22 * a44 - a24 * a42) - a12 * (a21 * a44 - a24 * a41) + a14 * (a21 * a42 - a22 * a41);
            float m34 =
                -(+a11 * (a22 * a43 - a23 * a42) - a12 * (a21 * a43 - a23 * a41) + a13 * (a21 * a42 - a22 * a41));
            float m41 =
                -(+a12 * (a23 * a34 - a24 * a33) - a13 * (a22 * a34 - a24 * a32) + a14 * (a22 * a33 - a23 * a32));
            float m42 = +a11 * (a23 * a34 - a24 * a33) - a13 * (a21 * a34 - a24 * a31) + a14 * (a21 * a33 - a23 * a31);
            float m43 =
                -(+a11 * (a22 * a34 - a24 * a32) - a12 * (a21 * a34 - a24 * a31) + a14 * (a21 * a32 - a22 * a31));
         ...
         */
        public static void diag(FMatrix4x4 input, FMatrix4 output)
        {
            output.a1 = input.a11;
            output.a2 = input.a22;
            output.a3 = input.a33;
         ...
         */
        public static FMatrix4 extractRow(FMatrix4x4 a, int row, FMatrix4 output)
        {
            if (output == null) output = new FMatrix4();
            switch (row)
            {
                case 0:
                    output.a1 = a.a11;
         ...
         */
        public static FMatrix4 extractColumn(FMatrix4x4 a, int column, FMatrix4 output)
        {
            if (output == null) output = new FMatrix4();
            switch (column)
            {
