 ...
 */
    public class CommonOps_FDF6
    {
         ...
         */
        public static void diag(FMatrix6x6 input, FMatrix6 output)
        {
            output.a1 = input.a11;
                output.a2 = input.a22;
                output.a3 = input.a33;
         ...
         */
        public static FMatrix6 extractRow(FMatrix6x6 a, int row, FMatrix6 output)
        {
            if ( output == null) output = new FMatrix6();
            switch (row)
            {
                case 0:
                output.a1 = a.a11;
         ...
         */
        public static FMatrix6 extractColumn(FMatrix6x6 a, int column, FMatrix6 output)
        {
            if ( output == null) output = new FMatrix6();
            switch (column)
            {
