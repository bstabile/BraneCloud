 ...
 */
    public class CommonOps_DDF6
    {
         ...
         */
        public static void diag(DMatrix6x6 input, DMatrix6 output)
        {
            output.a1 = input.a11;
            output.a2 = input.a22;
            output.a3 = input.a33;
         ...
         */
        public static DMatrix6 extractRow(DMatrix6x6 a, int row, DMatrix6 output)
        {
            if (output == null) output = new DMatrix6();
            switch (row)
            {
                case 0:
                    output.a1 = a.a11;
         ...
         */
        public static DMatrix6 extractColumn(DMatrix6x6 a, int column, DMatrix6 output)
        {
            if (output == null) output = new DMatrix6();
            switch (column)
            {
