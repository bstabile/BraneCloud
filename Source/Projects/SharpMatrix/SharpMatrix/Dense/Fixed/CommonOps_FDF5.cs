 ...
 */
    public class CommonOps_FDF5
    {
         ...
         */
        public static bool invert(FMatrix5x5 a, FMatrix5x5 inv)
        {
         ...
         */
        public static void diag(FMatrix5x5 input, FMatrix5 output)
        {
            output.a1 = input.a11;
                output.a2 = input.a22;
                output.a3 = input.a33;
         ...
         */
        public static FMatrix5 extractRow(FMatrix5x5 a, int row, FMatrix5 output)
        {
            if ( output == null) output = new FMatrix5();
            switch (row)
            {
                case 0:
                output.a1 = a.a11;
         ...
         */
        public static FMatrix5 extractColumn(FMatrix5x5 a, int column, FMatrix5 output)
        {
            if ( output == null) output = new FMatrix5();
            switch (column)
            {
