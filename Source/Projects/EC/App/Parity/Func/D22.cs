...
namespace BraneCloud.Evolution.EC.App.Parity.Func
{
    [ECConfiguration("ec.app.parity.func.D22")]
    public class D22 : GPNode
    {
        public override string ToString() { return "D22"; }
