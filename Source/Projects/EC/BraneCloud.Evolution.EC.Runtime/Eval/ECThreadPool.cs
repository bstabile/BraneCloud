...
{
    public class ECTaskPool : Dictionary<int, Task<ECTaskArgs>>
    {
        public ECTaskPool()
        {
    ...
    public class ECTaskArgs
    {
        ...
        public IEvolutionState State { get; private set; }
        public ISimpleProblem Problem { get; private set; }
        public Individual Individual { get; private set; }
        public int SubpopIndex { get; private set; }
