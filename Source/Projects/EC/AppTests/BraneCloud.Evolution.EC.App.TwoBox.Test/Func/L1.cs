...
namespace BraneCloud.Evolution.EC.App.TwoBox.Test.Func
{
    [ECConfiguration("ec.app.twobox.func.L1")]
    public class L1 : GPNode
    {
        public override string ToString() { return "l1"; }
