...
using BraneCloud.Evolution.EC.Problems.GPSemantics.Func;
using BraneCloud.Evolution.EC.Simple;

namespace BraneCloud.Evolution.EC.Problems.GPSemantics
{
    /**
     * Semantic.cs
     * 
    ...
    [ECConfiguration("ec.problems.gpsemantics.Semantic")]
