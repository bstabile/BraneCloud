...
namespace BraneCloud.Evolution.EC.Problems.Tutorial2
{
    [ECConfiguration("ec.problems.tutorial2.AddSubtract")]
    public class AddSubtractProblem : Problem, ISimpleProblem
    {
