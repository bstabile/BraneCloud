...
namespace BraneCloud.Evolution.EC.Problems.BBob
{
    /// <summary>
    ...
    /// </table>
    /// </summary>
    [ECConfiguration("ec.problems.bbob.BBOBenchmarksProblem")]
    public class BBOBenchmarksProblem : Problem, ISimpleProblem
    {
