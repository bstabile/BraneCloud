...
namespace BraneCloud.Evolution.EC.Problems.ECSuite
{
    /// <summary>
    ...
    /// </table>
    /// </summary>
    [ECConfiguration("ec.problems.ecsuite.ECSuiteProblem")]
    public class ECSuiteProblem : Problem, ISimpleProblem
    {
        #region Constants
       ...
       */
        ...
        public void CheckRange(IEvolutionState state, int problem)
        {
            ...
            for (var i = 0; i < state.Population.Subpops.Length; i++)
            {
                ...
                {
                    state.Output.Fatal("ECSuiteProblem requires species " + i + " to be a FloatVectorSpecies, but it is a: " +
        ...
        public double Function(IEvolutionState state, int function, double[] genome, int threadnum)
        {
            ...
            switch (function)
            {
                ...
                default:
                    state.Output.Fatal("ec.problems.ecsuite.ECSuiteProblem has an invalid problem -- how on earth did that happen?");
