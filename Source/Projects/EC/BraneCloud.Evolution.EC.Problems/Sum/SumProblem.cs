...
namespace BraneCloud.Evolution.EC.Problems.Sum
{
    [ECConfiguration("ec.problems.sum.Sum")]
    public class SumProblem : Problem, ISimpleProblem
    {
        public const string P_SUM = "sum";

        public override IParameter DefaultBase
        {
            get { return base.DefaultBase.Push(P_SUM); }
        }
