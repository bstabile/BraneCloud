...
namespace BraneCloud.Evolution.EC.Problems.Lawnmower
{
    /// <summary>
    ...
    /// </table>
    /// </summary>
    [ECConfiguration("ec.problems.lawnmower.Lawnmower")]
    public class LawnmowerProblem : GPProblem, ISimpleProblem
    {
        ...
        {
            var myobj = (LawnmowerProblem)(base.Clone());
