...
using BraneCloud.Evolution.EC.Problems.ECSuite;
using BraneCloud.Evolution.EC.Vector;

namespace BraneCloud.Evolution.EC.Problems.Coevolve2
{
    [ECConfiguration("ec.problems.coevolve2.CoevolutionaryECSuiteProblem")]
    public class CoevolutionaryECSuiteProblemProblem : ECSuite.ECSuiteProblem, IGroupedProblem
    {
        #region Constants
        ...
        {
            if (ind.Length == 0)
                state.Output.Fatal("Number of individuals provided to CoevolutionaryECSuiteProblem is 0!");
            if (ind.Length == 1)
                state.Output.WarnOnce("Coevolution used, but number of individuals provided to CoevolutionaryECSuiteProblem is 1.");
