...
namespace BraneCloud.Evolution.EC.Problems.Coevolve1
{
    [ECConfiguration("ec.problems.coevolve1.CompetitiveMaxOnesProblem")]
    public class CompetitiveMaxOnesProblem : Problem, IGroupedProblem
    {
