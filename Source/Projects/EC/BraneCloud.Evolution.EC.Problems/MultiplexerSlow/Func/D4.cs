...
{
    [ECConfiguration("ec.problems.multiplexerslow.func.D4")]
    public class D4 : GPNode
    {
        public override string ToString() { return "d4"; }
            ...
            IProblem problem)
        {
            ((MultiplexerData)input).x =
                ((((MultiplexerProblem)problem).dataPart >> 4) & 1);
        }
    }
}