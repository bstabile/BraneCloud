...
{
    [ECConfiguration("ec.problems.multiplexerslow.func.D3")]
    public class D3 : GPNode
    {
        public override string ToString() { return "d3"; }
            ...
            IProblem problem)
        {
            ((MultiplexerData)input).x =
                ((((MultiplexerProblem)problem).dataPart >> 3) & 1);
        }
    }
}