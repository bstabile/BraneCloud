...
{
    [ECConfiguration("ec.problems.multiplexerslow.func.D6")]
    public class D6 : GPNode
    {
        public override string ToString() { return "d6"; }
            ...
            IProblem problem)
        {
            ((MultiplexerData)input).x =
                ((((MultiplexerProblem)problem).dataPart >> 6) & 1);
        }
    }
}