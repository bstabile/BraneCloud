...
{
    [ECConfiguration("ec.problems.multiplexerslow.func.D2")]
    public class D2 : GPNode
    {
        public override string ToString() { return "d2"; }
            ...
            IProblem problem)
        {
            ((MultiplexerData)input).x =
                ((((MultiplexerProblem)problem).dataPart >> 2) & 1);
        }
    }
}