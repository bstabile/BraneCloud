...
{
    [ECConfiguration("ec.problems.multiplexerslow.func.D5")]
    public class D5 : GPNode
    {
        public override string ToString() { return "d5"; }
            ...
            IProblem problem)
        {
            ((MultiplexerData)input).x =
                ((((MultiplexerProblem)problem).dataPart >> 5) & 1);
        }
    }
}