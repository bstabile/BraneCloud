...
{
    [ECConfiguration("ec.problems.multiplexerslow.func.D7")]
    public class D7 : GPNode
    {
        public override string ToString() { return "d7"; }
            ...
            IProblem problem)
        {
            ((MultiplexerData)input).x =
                ((((MultiplexerProblem)problem).dataPart >> 7) & 1);
        }
    }
}