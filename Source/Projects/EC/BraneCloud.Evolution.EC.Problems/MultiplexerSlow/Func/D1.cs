...
{
    [ECConfiguration("ec.problems.multiplexerslow.func.D1")]
    public class D1 : GPNode
    {
        public override string ToString() { return "d1"; }
            ...
            IProblem problem)
        {
            ((MultiplexerData)input).x =
                ((((MultiplexerProblem)problem).dataPart >> 1) & 1);
        }
    }
}