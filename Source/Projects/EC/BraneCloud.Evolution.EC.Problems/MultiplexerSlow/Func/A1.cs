...
namespace BraneCloud.Evolution.EC.Problems.MultiplexerSlow.Func
{
    [ECConfiguration("ec.problems.multiplexerslow.func.A1")]
    public class A1 : GPNode
    {
        public override string ToString() { return "a1"; }
            ...
            IProblem problem)
        {
            ((MultiplexerData)input).x =
                ((((MultiplexerProblem)problem).addressPart >> 1) & 1);
        }
    }
}