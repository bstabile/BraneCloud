...
namespace BraneCloud.Evolution.EC.Problems.MultiplexerSlow
{
    ...
    /// </table>
    /// </summary>
    [ECConfiguration("ec.problems.multiplexerslow.Multiplexer")]
    public class MultiplexerProblem : GPProblem, ISimpleProblem
    {
        ...
        {
            var myobj = (MultiplexerProblem)(base.Clone());
