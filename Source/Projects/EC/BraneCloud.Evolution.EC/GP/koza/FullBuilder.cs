...
namespace BraneCloud.Evolution.EC.GP.Koza
{
    ...
    /// It then grows a full tree of depth <i>d</i>.
    /// 
    ...
    /// Also, for all three algorithms (RAMPED HALF/HALF, GROW, FULL), 
    ...
    /// <br/>
    /// <br/>
    /// The table cell is empty when that parameter is not defined by the system by default.  Koza II has two values 
    /// each because of a possible typo in the text -- while page 656 gives one maximum,  page 671 gives another.  
    ...
    /// </summary>
    [Serializable]
    [ECConfiguration("ec.gp.koza.FullBuilder")]
    public class FullBuilder : KozaBuilder
    {
        #region Constants

        public const string P_FULLBUILDER = "full";
        ...
        {
            get { return GPKozaDefaults.ParamBase.Push(P_FULLBUILDER); }
        }
