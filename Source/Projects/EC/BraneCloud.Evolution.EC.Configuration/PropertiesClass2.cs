...
namespace BraneCloud.Evolution.EC.Configuration
{
    ...
    /// @since JDK1.0
    /// </summary>
    public class PropertiesClass2 : Dictionary<string, string> // Dictionary<Object, Object> // .NET does not have a generic Hashtable.
    {
        #region Constants
        ...
        /// </summary>
        protected PropertiesClass2 Defaults { get; set; }
        ...
        public PropertiesClass2(PropertiesClass2 defaults)
        {
        ...
        {
            var oval = this[key];
            var sval = (oval is String) ? oval.Trim() : null;
        ...
        private void Enumerate(IDictionary<string, string> h)
        {
            lock (this)
            {
                if (Defaults != null)
